...
##### OPTIONS ######################################################################################################################
column  = 14                          # Column in dust file you want plot
...
val_min = 0.                          # Minimum and maximum value you want
val_max = 1.                          #     to plot.
log     = False                       # Shall the scale be loagrithmic?

col_min = val_min                     # Minimum and maximum value
col_max = val_max                     #     of colorbar
cmap    = 'jet'                       # What colorbar do you want?
clabel  = r'Crystallintity fraction'  # Label of the colorbar. LaTeX allowed.
